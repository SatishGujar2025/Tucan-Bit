        ...
        <div className="flex flex-col h-full">
          ...
          <nav className="flex-1 overflow-y-auto p-4 space-y-1">
            <button
              ...
              className={`w-full flex items-center space-x-3 p-3 rounded-lg text-[15px] text-white hover:bg-gray-800`}
            >
            ...
            <button
              ...
              className={`w-full flex items-center space-x-3 p-3 rounded-lg text-white hover:bg-gray-800`}
            >
            ...
            <button
              ...
              className={`w-full flex items-center space-x-3 p-3 rounded-lg text-white bg-gradient-to-r from-yellow-500/20 to-orange-500/20`}
            >
            ...
            <div>
              ...
              {activeSubmenu === 'support' && (
                <div className="pl-10 pt-2 space-y-2">
                  <button onClick={() => handleNavigate('help')} className="flex items-center space-x-2 p-2 text-sm text-gray-300 hover:text-white">
                    <HelpCircle className="w-4 h-4" />
                    <span>Help Center</span>
                  </button>
                  <button onClick={() => handleNavigate('contact')} className="flex items-center space-x-2 p-2 text-sm text-gray-300 hover:text-white">
                    <MessageCircle className="w-4 h-4" />
                    <span>Contact Us</span>
                  </button>
                  <button onClick={() => handleNavigate('responsible-gaming')} className="flex items-center space-x-2 p-2 text-sm text-gray-300 hover:text-white">
                    <Shield className="w-4 h-4" />
                    <span>Responsible Gaming</span>
                  </button>
                  <button onClick={() => handleNavigate('fairness')} className="flex items-center space-x-2 p-2 text-sm text-gray-300 hover:text-white">
                    <Scale className="w-4 h-4" />
                    <span>Fairness</span>
                  </button>
                  <button onClick={() => handleNavigate('terms')} className="flex items-center space-x-2 p-2 text-sm text-gray-300 hover:text-white">
                    <FileText className="w-4 h-4" />
                    <span>Terms of Service</span>
                  </button>
                  <button onClick={() => handleNavigate('privacy')} className="flex items-center space-x-2 p-2 text-sm text-gray-300 hover:text-white">
                    <Lock className="w-4 h-4" />
                    <span>Privacy Policy</span>
                  </button>
                  <button onClick={() => handleNavigate('cookies')} className="flex items-center space-x-2 p-2 text-sm text-gray-300 hover:text-white">
                    <Cookie className="w-4 h-4" />
                    <span>Cookie Policy</span>
                  </button>
                  <button onClick={() => handleNavigate('licensing')} className="flex items-center space-x-2 p-2 text-sm text-gray-300 hover:text-white">
                    <Award className="w-4 h-4" />
                    <span>Licensing</span>
                  </button>
                  <button onClick={() => handleNavigate('security')} className="flex items-center space-x-2 p-2 text-sm text-gray-300 hover:text-white">
                    <Shield className="w-4 h-4" />
                    <span>Security</span>
                  </button>
                </div>
