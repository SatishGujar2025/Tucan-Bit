        ...
        <div className="flex flex-col h-full">
          ...
          <nav className="flex-1 overflow-y-auto p-4 space-y-1">
            ...
            <button
              ...
              className={`w-full flex items-center space-x-3 p-3 rounded-lg text-white ${currentPage === 'games' ? 'bg-gradient-to-r from-yellow-500/20 to-orange-500/20' : 'hover:bg-gray-800'}`}
            >
            ...
            <div>
              ...
              {activeSubmenu === 'games' && (
                <div className="pl-10 pt-2 space-y-2">
                  <button onClick={() => setSelectedCategory('slots')} className="flex items-center space-x-2 p-2 text-sm text-gray-300 hover:text-white">
                    <span>🎰</span>
                    <span>Slots</span>
                  </button>
                  <button onClick={() => setSelectedCategory('table-games')} className="flex items-center space-x-2 p-2 text-sm text-gray-300 hover:text-white">
                    <span>🎲</span>
                    <span>Table Games</span>
                  </button>
                  <button onClick={() => setSelectedCategory('live-casino')} className="flex items-center space-x-2 p-2 text-sm text-gray-300 hover:text-white">
                    <span>🎥</span>
                    <span>Live Casino</span>
                  </button>
                  <button onClick={() => setSelectedCategory('jackpots')} className="flex items-center space-x-2 p-2 text-sm text-gray-300 hover:text-white">
                    <span>💰</span>
                    <span>Jackpots</span>
                  </button>
                  <button onClick={() => setSelectedCategory('crypto-games')} className="flex items-center space-x-2 p-2 text-sm text-gray-300 hover:text-white">
                    <span>₿</span>
                    <span>Crypto Games</span>
                  </button>
                  <button onClick={() => setSelectedCategory('arcade')} className="flex items-center space-x-2 p-2 text-sm text-gray-300 hover:text-white">
                    <span>🕹️</span>
                    <span>Arcade</span>
                  </button>
                </div>
