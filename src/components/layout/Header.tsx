...
const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-[999999] bg-gradient-to-r from-black to-gray-800 backdrop-blur-md border-b border-gray-800/30 shadow-lg shadow-black/30">
