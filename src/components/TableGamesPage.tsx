...
import {
  ...
  Search, Filter,ZapIcon, Grid, List, Star as StarIcon, TrendingUp as TrendingUpIcon
} from 'lucide-react';

type TableGamesPageProps = {
  onNavigate?: (page: string) => void;
};

const TableGamesPage: React.FC<TableGamesPageProps> = ({ onNavigate }) => {
  ...
  const [currentPage, setCurrentPage] = useState('table-games');
  ...
  // Generate table games data
  const generateTableGames = () => {
    const gameNames = [
      'Blackjack Classic', 'European Roulette', 'American Roulette', 'Baccarat', 'Poker Texas Hold\'em',
      'Caribbean Stud Poker', 'Three Card Poker', 'Pai Gow Poker', 'Casino Hold\'em', 'Oasis Poker',
      'Ultimate Texas Hold\'em', 'Let It Ride', 'Red Dog', 'War', 'Craps',
      'Sic Bo', 'Dragon Tiger', 'Fan Tan', 'Mahjong', 'Keno',
      'Lightning Blackjack', 'Lightning Roulette', 'Speed Baccarat', 'VIP Blackjack', 'VIP Roulette',
      'Mega Roulette', 'Auto Roulette', 'French Roulette', 'Multi-Wheel Roulette', 'Immersive Roulette',
      'Blackjack Party', 'Blackjack VIP', 'Blackjack Professional', 'Blackjack Gold', 'Blackjack Platinum',
      'Baccarat Squeeze', 'Baccarat Control Squeeze', 'Speed Baccarat', 'Baccarat VIP', 'Baccarat Gold',
      'Poker Room', 'Poker Tournament', 'Poker Cash Game', 'Poker Sit & Go', 'Poker Spin & Go',
      'Hold\'em Manager', 'Poker Tracker', 'PokerStars', '888 Poker', 'Party Poker',
      'Full Tilt Poker', 'PokerStars VR', 'Poker Night', 'Poker Face', 'Poker Pro',
      'Roulette Royale', 'Roulette Elite', 'Roulette Supreme', 'Roulette Master', 'Roulette Champion',
      'Blackjack Master', 'Blackjack Elite', 'Blackjack Supreme', 'Blackjack Champion', 'Blackjack Legend',
      'Baccarat Master', 'Baccarat Elite', 'Baccarat Supreme', 'Baccarat Champion', 'Baccarat Legend',
      'Poker Master', 'Poker Elite', 'Poker Supreme', 'Poker Champion', 'Poker Legend',
      'Table Games Pro', 'Table Games Elite', 'Table Games Supreme', 'Table Games Champion', 'Table Games Legend'
    ];
    ...
    const types = ['Blackjack', 'Roulette', 'Baccarat', 'Poker', 'Craps', 'Sic Bo', 'Dragon Tiger', 'Fan Tan', 'Mahjong', 'Keno'];
    const volatilities = ['Low', 'Medium', 'High', 'Very High'];
    const maxWins = ['x2', 'x3', 'x5', 'x10', 'x20', 'x35', 'x100', 'x500', 'x1000', 'Progressive'];
  ...
  const filteredGames = allTableGames.filter(game => {
    ...
    const matchesCategory = selectedCategory === 'all' || 
                           (selectedCategory === 'blackjack' && game.type === 'Blackjack') ||
                           (selectedCategory === 'roulette' && game.type === 'Roulette') ||
                           (selectedCategory === 'baccarat' && game.type === 'Baccarat') ||
                           (selectedCategory === 'poker' && game.type === 'Poker') ||
            ...
            <div>
              ...
              {activeSubmenu === 'games' && (
                <div className="pl-10 pt-2 space-y-2">
                  ...
                  <button onClick={() => handleNavigate('table-games')} className="flex items-center space-x-2 p-2 text-sm text-white bg-gradient-to-r from-yellow-500/20 to-orange-500/20 rounded">
                 ...
                 <div className="relative z-10 text-center">
                   <div className="mb-8">
                     <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-yellow-500/20 to-orange-500/20 border border-yellow-500/30 rounded-full px-6 py-2 mb-6">
                       ...
                       <span className="text-yellow-400 font-semibold">300+ Table Games Available</span>
                       <ZapIcon className="w-5 h-5 text-yellow-400" />
                     </div>
                     ...
                     <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
                       <div className="bg-gradient-to-r from-blue-500/20 to-cyan-500/20 border border-blue-500/30 rounded-xl p-4 text-center">
                         ...
                         <div className="text-sm text-gray-300">Table Games</div>
                       </div>
                       <div className="bg-gradient-to-r from-green-500/20 to-emerald-500/20 border border-green-500/30 rounded-xl p-4 text-center">
                         ...
                         <div className="text-sm text-gray-300">Table Players</div>
                       </div>
                       <div className="bg-gradient-to-r from-yellow-500/20 to-orange-500/20 border border-yellow-500/30 rounded-xl p-4 text-center">
                         ...
                         <div className="text-sm text-gray-300">Table Winnings</div>
                       </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col lg:flex-row gap-4 items-center justify-between">
              <div className="relative flex-1 max-w-md">
                ...
                <input
                  type="text"
                  placeholder="Search table games, providers, themes..."
                  value={searchTerm}
