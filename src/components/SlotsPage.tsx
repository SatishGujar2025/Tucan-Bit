...
import {
  ...
  ArrowLeft, Filter as FilterIcon, Shuffle, Target as TargetIcon, Zap as ZapIcon
} from 'lucide-react';
...
const SlotsPage: React.FC<SlotsPageProps> = ({ onNavigate }) => {
  ...
  const providers = ['all', ...Array.from(new Set(allSlotGames.map(game => game.provider)))];
  const themes = ['all', ...Array.from(new Set(allSlotGames.map(game => game.theme)))];
  const volatilities = ['all', 'Low', 'Medium', 'High', 'Very High'];

  const filteredGames = allSlotGames.filter(game => {
            ...
            <div className="relative z-10 text-center">
              <div className="mb-8">
                <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-yellow-500/20 to-orange-500/20 border border-yellow-500/30 rounded-full px-6 py-2 mb-6">
                  ...
                  <span className="text-yellow-400 font-semibold">300+ Slot Games Available</span>
                  <ZapIcon className="w-5 h-5 text-yellow-400" />
                </div>
                ...
                <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto leading-relaxed">
                  Spin your way to fortune! Discover the most exciting slot games with 
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
                  <div className="bg-gradient-to-r from-blue-500/20 to-cyan-500/20 border border-blue-500/30 rounded-xl p-4 text-center">
                    ...
                    <div className="text-sm text-gray-300">Slot Games</div>
                  </div>
                  ...
                  <div className="bg-gradient-to-r from-yellow-500/20 to-orange-500/20 border border-yellow-500/30 rounded-xl p-4 text-center">
                    ...
                    <div className="text-sm text-gray-300">Slot Winnings</div>
                  </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col lg:flex-row gap-4 items-center justify-between">
              <div className="relative flex-1 max-w-md">
                ...
                <input
                  type="text"
                  placeholder="Search slot games, providers, themes..."
                  value={searchTerm}
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="text-gray-400">
                  <span className="font-semibold text-white">{filteredGames.length}</span> slots found
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <div className="relative">
                <select
                  ...
                  className="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-xl text-white focus:outline-none focus:border-yellow-500 transition-colors appearance-none"
                >
                ...
                >
                  {volatilities.map(volatility => (
                    <option key={volatility} value={volatility}>
                      {volatility === 'all' ? 'All Volatility' : volatility}
                    </option>
                  ))}
                </select>
                <ChevronDown className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 w-5 h-5 pointer-events-none" />
              ...
              <button
                ...
                className="px-4 py-3 bg-gradient-to-r from-red-500 to-pink-500 text-white rounded-xl font-semibold hover:from-red-600 hover:to-pink-600 transition-all duration-200 flex items-center justify-center space-x-2"
              >
          ...
          <div className="max-w-7xl mx-auto">
            ...
            {filteredGames.length === 0 && (
              <div className="text-center py-20">
                ...
                <h3 className="text-xl font-bold text-gray-400 mb-2">No slot games found</h3>
