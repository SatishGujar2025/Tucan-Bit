    ...
    <>
      ...
      <Routes>
        <Route path="/" element={<Layout />}>
          ...
          <Route path="games" element={<GamesPage onBack={() => window.history.back()} />} />
          ...
          {/* PROTECTED ROUTES - User-specific features requiring authentication */}
          ...
          <Route path="task-dashboard" element={<ProtectedRoute><TaskDashboardPage /></ProtectedRoute>} />
          <Route path="get-paid" element={<ProtectedRoute><GetPaidPage /></ProtectedRoute>} />
