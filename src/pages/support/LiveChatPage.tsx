              ...
              <div className="h-96 overflow-y-auto p-6 space-y-4">
                    ...
                    <div
                      className={`max-w-xs lg:max-w-md px-4 py-3 rounded-2xl ${
                        message.sender === 'user'
                          ...
                          : 'bg-black/30 text-gray-200 border border-[#3C1A4F]/50'
                      }`}
                    >
                ...
                {isTyping && (
                  <div className="flex justify-start">
                    <div className="bg-black/30 border border-[#3C1A4F]/50 rounded-2xl px-4 py-3">
                ...
                <div className="flex space-x-3">
                  <div className="flex-1 relative">
                    <textarea
                      ...
                      className="w-full bg-black/20 border border-[#3C1A4F]/50 rounded-xl px-4 py-3 text-white placeholder-gray-400 resize-none focus:outline-none focus:border-[#F25287] focus:ring-1 focus:ring-[#F25287]"
                      rows={2}
                    />
                  </div>
                  <button
          ...
          <div className="space-y-6">
            ...
            <div className="bg-black/20 backdrop-blur-sm border border-[#3C1A4F]/30 rounded-2xl p-6">
              ...
              <div className="space-y-3">
                <button className="w-full bg-black/30 hover:bg-black/50 border border-[#3C1A4F]/50 rounded-xl px-4 py-3 text-left text-gray-300 hover:text-white transition-colors">
