      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
              ...
              <div className="space-y-4">
                {contactMethods.map((method, index) => {
                  ...
                  return (
                    <div
                      key={index}
                      className="bg-gray-800/30 border border-gray-700 rounded-xl p-6 hover:border-gray-600 transition-all duration-300 cursor-pointer"
                    >
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <button className="bg-gray-700 text-white px-4 py-2 rounded-lg font-semibold hover:bg-gray-600 transition-all duration-200 text-sm">
                          {method.action}
                        </button>
                      </div>
                    </div>
          ...
          <div className="lg:col-span-2">
            <div className="bg-black/20 rounded-xl p-8 border border-gray-700">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full bg-gray-700 text-white py-4 rounded-lg font-semibold hover:bg-gray-600 transition-all duration-200 flex items-center justify-center space-x-2"
                >
