...
import { Trophy, Clock, Gamepad2, ChevronLeft, ChevronRight, Crown } from 'lucide-react';
import promoGatekeeper from '../../assets/tucanbit_promo_gatekeeper.png';

const VIPTournamentPage: React.FC = () => {
  ...
  const participatingGames = [
    { id: 1, name: "VIP Roulette", image: "🎲", live88: true },
    { id: 2, name: "Elite Baccarat", image: "🃏", live88: true },
    { id: 3, name: "Royal Blackjack", image: "♠️", live88: true },
    { id: 4, name: "Premium Dragon", image: "🐉", live88: true },
    { id: 5, name: "Luxury Speed", image: "⚡", live88: true },
    { id: 6, name: "Diamond Jack", image: "💎", live88: true },
    { id: 7, name: "Crown Riches", image: "👑", live88: true },
    { id: 8, name: "VIP Multiplier", image: "🌊", live88: true },
  ];

  const leaderboard = [
    { place: 1, player: "vip_elite", points: "89,456", prize: "$12,000" },
    { place: 2, player: "royal_member", points: "67,234", prize: "$8,000" },
    { place: 3, player: "premium_player", points: "54,789", prize: "$5,000" },
    { place: 4, player: "luxury_gamer", points: "43,567", prize: "$3,000" },
    { place: 5, player: "elite_winner", points: "38,901", prize: "$2,000" },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
      ...
      <div className="relative h-96 overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-between p-8">
          <div className="text-white">
            <h1 className="text-5xl font-bold mb-4">Gatekeeper</h1>
      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
        <div className="text-center mb-8">
          <h2 className="text-4xl font-bold text-white mb-2">VIP TOURNAMENT</h2>
          <h3 className="text-2xl font-bold text-yellow-400">JOIN NOW!</h3>
        </div>
        ...
        <div className="bg-gray-800 rounded-xl p-8 mb-8">
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              <h4 className="text-xl font-bold text-white mb-4">VIP Benefits</h4>
              <ul className="space-y-3 text-gray-300">
                <li>• Exclusive VIP-only tournament access</li>
                <li>• Higher point multipliers for VIP members</li>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-gray-700 rounded-lg p-4">
                  ...
                  <div className="text-white font-semibold">VIP Only</div>
                </div>
                <div className="bg-gray-700 rounded-lg p-4">
...
export default VIPTournamentPage; 